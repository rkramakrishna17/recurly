...
public class TestUtils {
    ...
    public static RecurlyUnitCurrency createRandomPrice() {
        ...
        price.setUnitAmountINR(LifecycleTest.randomInteger(10));
    ...
    public static RecurlyUnitCurrency createRandomSinglePrice(final String currencyCode) {
        ...
        if (currencyCode.endsWith("INR")) {
            price.setUnitAmountINR(randomInteger(10));
        }
    ...
    public static String createRandomCurrency() {
        final String[] currencies = {"EUR", "GBP", "INR", "SEK"};
